...
/*============== WATERMARK ==============*/
global.wm = 'By Kotori-MD' //Main Watermark
global.wm2 = 'Ardian'
global.wm3 = 'Kotori-MD | By Ardian'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `Kotori-MD | ʙʏ ${global.nameown}`
global.author = 'Ardian' 
global.packname = 'Ardian'
global.danied = '✘ Ardian'
global.ultahowner = 'Februari 12 2025'
...
global.botintro = 'Hallo, Kenalin saya Kotori-MD Saya akan membantu Anda kapan pun & Dimana pun, Saya asisten bot WhatsApp yang di buat oleh Ardian Saya di rilis pada tanggal\n🗓 ️_16/10/2022_'
...
global.pacarowner = 'Ardian Yosepa'

/*============== TEXT ==============*/
global.wait = '```𝙇𝙤𝙖𝙙𝙞𝙣𝙜...```'
global.eror = '``` 𝙁𝙤𝙪𝙣𝙙 𝟰𝟬𝟰 𝙀𝙧𝙤𝙧```'
